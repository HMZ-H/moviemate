...
interface FeaturedMovieGridProps {
  title: string;
  movies: TMDBItem[];
  maxItems?: number;
}

const FeaturedMovieGrid: React.FC<FeaturedMovieGridProps> = ({ 
  title, 
  movies, 
  maxItems = 8 
}) => {
  ...
  return (
    <div className="w-full py-16">
      <div className="w-full px-4">
        <h2 className="text-4xl font-black mb-8 bg-gradient-to-r from-purple-400 to-pink-400 bg-clip-text text-transparent text-center">
          {title}
        </h2>
...
export default FeaturedMovieGrid;
